...
void HexTile::Draw()
{
    ...
    glColor4f( Color.r * 1.f/255.f, Color.g * 1.f/255.f, Color.b * 1.f/255.f, Color.a * 1.f/255.f);
...
void HexTile::drawGrid()
{
    /*    const float DEG2RAD = 3.14159/180;
        ...
        glBegin(GL_QUADS);
        glColor4f( gridColor.r * 1.f/255.f, gridColor.g * 1.f/255.f, gridColor.b * 1.f/255.f, gridColor.a * 1.f/255.f);
        for (int i=0; i <360; i+=60)
        {
            float degInRad = (i+30)*DEG2RAD;
