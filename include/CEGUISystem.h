...
public:
    ...
    virtual void subscribeFunction(std::string windowName, std::function<void(void)> function);
    virtual void subscribeFunction(std::string parentName, std::string windowName, std::function<void(void)> function);
