...
public:
  ...
  void setCameraPos(const Vector3f &Pos) { m_camera.Pos = Pos; }
  ...
  Vector3f getObjectScale() { return m_Object.Scale; }

  void setObjectScale(const Vector3f &newScale) { m_Object.Scale = newScale; }

  Vector3f getCameraPos() { return m_camera.Pos; }
  const Vector3f getCameraTarget() { return m_camera.Target; }
  Vector3f getCameraUp() { return m_camera.Up; }
