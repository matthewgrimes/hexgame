...
enum Directions { EAST, NORTHEAST, NORTHWEST, WEST, SOUTHWEST, SOUTHEAST, NONE};
const char DirectionStrings[7][10] = { "EAST", "NORTHEAST", "NORTHWEST", "WEST", "SOUTHWEST", "SOUTHEAST", "NONE" };
const char AttackDirectionStrings[6][15] = { "REAR", "REAR FLANK", "FRONT FLANK", "FRONT", "FRONT FLANK", "REAR FLANK" };
