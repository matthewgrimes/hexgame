...
public:
    ...
    void addResourceFromFile(const std::string& fileName, const std::string& resourceHandle);
private:
...
template <typename T>
void ResourcePool<T>::addResource(const std::string& newHandle, const T& newResource)
{
...
template <typename T>
void ResourcePool<T>::addResourceFromFile(const std::string& fileName, const std::string& resourceHandle)
{
