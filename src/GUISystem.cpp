...
void NullGUISystem::subscribeFunction(std::string windowName, std::function<void(void)> function)
{
}

void NullGUISystem::subscribeFunction(std::string parentName, std::string windowName, std::function<void(void)> function)
{
}
