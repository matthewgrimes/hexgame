...
public:
  ...
  void setLevel(int level) { Position.setLevel(level); }
  ...
  int getDirection() { return Angle / 60; }
  void setDirection(int value) { Angle = 60 * value; }

  int getLevel() { return Position.getLevel(); }

  double getTurnCountdown() { return turnCountdown; }
  void incrementTurnCountdown(double v) { turnCountdown += v; }
  void scaleTurnCountdown(double v) { turnCountdown *= v; }
  void setTurnCountdown(double v) { turnCountdown = v; }
